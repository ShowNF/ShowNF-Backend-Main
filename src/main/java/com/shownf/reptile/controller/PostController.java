...
public class PostController {
    ...
    public Page<Long> getPosts(@PathVariable Long userId, @PageableDefault(size=15, sort="uploadTime", direction = Sort.Direction.DESC) Pageable pageable){
    ...
    @GetMapping("post/hot")
    public Page<Long> getHotPosts(@PageableDefault(size=15, sort="heartCount", direction = Sort.Direction.DESC) Pageable pageable){
