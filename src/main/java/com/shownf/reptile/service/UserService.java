...
import com.shownf.reptile.bean.SaveFollowBean;
...
public class UserService {
    ...
    @Autowired
    public UserService(GetUserIdBean getUserIdBean, GetUserBean getUserBean, UpdateUserSiteNameBean updateUserSiteNameBean, SaveFollowBean saveFollowBean) {
