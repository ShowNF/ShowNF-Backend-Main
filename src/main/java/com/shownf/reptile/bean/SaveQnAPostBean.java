...
public class SaveQnAPostBean {
    ...
    @Autowired
    public SaveQnAPostBean(CreateUniqueIdBean createUniqueIdBean, UpdateUserPostCountDAOBean updateUserPostCountDAOBean, UpdateUserExpDAOBean updateUserExpDAOBean, SaveQnAPostDAOBean saveQnAPostDAOBean, SaveUserDAOBean saveUserDAOBean) {
