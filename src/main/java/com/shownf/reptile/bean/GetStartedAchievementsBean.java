...
@Component
public class GetStartedAchievementsBean {

    GetUserDAOBean getUserDAOBean;
    GetAchievementsDAOBean getAchievementsDAOBean;

    @Autowired
    public GetStartedAchievementsBean(GetUserDAOBean getUserDAOBean, GetAchievementsDAOBean getAchievementsDAOBean) {
    ...
    public List<ResponseAchievementDTO> exec(Long userId){
        ...
        // 유저의 시작한 업적 가져오기
        return getAchievementsDAOBean.exec(null, userDAO);
    }
}
